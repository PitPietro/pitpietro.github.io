...
### Modify the LaunchRequestHandler
...
## Collect slots turn-by-turn with auto-delegation
...
### Use intent ans slots to catch information
...
#### Add the slot type to the slots
...
## Make the skill able to save information
...
#### Add the AttributesManager dependency
...
### Get information for Alexa Settings API
...
### Use the Alexa Settings API to get the user time zone
...
### Get the current date & extract day, month and year
...
### Compute difference between current date and user's next birthday
...
## Final Test with an Alexa-based device
...
...
## Reference
[Cake Time - 1](https://github.com/alexa/skill-sample-python-first-skill/tree/master/module-1)
[Cake Time - 2](https://github.com/alexa/skill-sample-python-first-skill/tree/master/module-2)
[Cake Time - 3](https://github.com/alexa/skill-sample-python-first-skill/tree/master/module-3)
[Cake Time - 4](https://github.com/alexa/skill-sample-python-first-skill/tree/master/module-4)
[when to use i.e. and e.g.](https://www.thoughtco.com/when-to-use-common-latin-abbreviations-116688)